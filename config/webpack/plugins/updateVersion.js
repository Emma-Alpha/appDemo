class UpdateVersionWebpackPlugin {

  static defaultOptions = {
    name: "update_version.json",
  }

  constructor(options = {}) {
    this.options = { ...UpdateVersionWebpackPlugin.defaultOptions, ...options }
  }

  apply(compiler) {
    const pluginName = UpdateVersionWebpackPlugin.name;
